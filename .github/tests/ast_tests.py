...
def test_lazyframe_sub_pipeline_caching():
    """Test that sub-pipelines share cache."""
...
def test_sem_join_with_lazyframe():
...
@pytest.mark.parametrize("model", get_enabled("gpt-4o-mini"))
def test_complex_pipeline(setup_models, model):
