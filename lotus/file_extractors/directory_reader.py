...
class DirectoryReader:
    ...
    def load_data(
        ...
        Args:
            ...
            num_workers: Number of workers to use for parallel processing.
                If None, uses the default number of workers.
    ...
    def to_df(
        ...
        Args:
            per_page: If True, return the content of each page as a separate row
                if the document has multiple pages. If False, merge pages from
                the same document. Default is True.
            page_separator: The separator to use when joining the content of each
                page in case per_page is False. Default is "\n".
            show_progress: If True, show a progress bar while loading files.
                Default is False.
            num_workers: The number of workers to use for loading files.
                If None, uses the default number of workers.

        Returns:
            pd.DataFrame: DataFrame containing document content and metadata.
                Columns include 'content' and various metadata fields.
